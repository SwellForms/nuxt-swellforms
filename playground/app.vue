<script setup>
import { ref } from 'vue'
import {useSwellForm} from "../src/runtime/composables/useSwellForm.js";
    ...
    <div class="font-sans bg-gray-50 min-h-screen flex items-center justify-center p-4">
      <div class="w-full max-w-lg">
        <div class="bg-white rounded-lg shadow-lg p-8">
          <h1 class="text-2xl font-bold text-gray-800 mb-2">Swell Forms Demo</h1>
          <p class="text-gray-600 mb-6">This form is powered by `nuxt-swellforms`.</p>
          ...
          <div v-if="formMessage" class="mt-6 p-4 rounded-md" :class="isSuccess ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'">
            <p class="font-medium">{{ isSuccess ? 'Success!' : 'Oops!' }}</p>
